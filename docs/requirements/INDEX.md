...
| 014 | feat | [地址栏下方显示当前对话 token 量](./014-shell-token-bar.md) | review | feat/014-shell-token-bar | 2026-09-25 |
| 015 | feat | [token 按会话缓存 + 去掉高频轮询（改主进程推送）](./015-token-cache-no-poll.md) | doing | feat/015-token-cache-no-poll | 2026-09-26 |
